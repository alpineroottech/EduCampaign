...
import { poppins , numans} from "@/components/ui/fonts/fonts";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        // className={`${poppins.variable} ${numans.variable} antialiased   `}
        className={`${poppins.variable} ${numans.variable} antialiased relative`}
      >
        <GlobalBackground />
        <Header />
        {children}
