...
export default function PTE() {
  ...
  return (
    <div className="mb-20">
      ...
      <div className="">
        <Breadcrumbs />
        <HeroSection imageSrc="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1600&q=80" title="PTE Preparation" />

        <div className="text-center max-w-5xl mx-auto py-8 px-6">
          <p className="t leading-relaxed">
            The PTE is a computer-based test assessing listening, reading, speaking, and writing skills in an academic context. The test is divided into three main sections:
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl text-center mx-auto px-4 sm:px-6">
        ...
        <h4 className="pt-8 sm:pt-10 text-lg sm:text-xl">The test consists of three sections:</h4>
      </div>
        ...
        {[
          {
            ...
            description: "Includes tasks such as personal introduction, read aloud, repeat sentences, describe images, re-tell lectures, answer short questions, summarize written text, and essay writing.",
            button: "Learn More ",
          },
          {
            title: "Reading (32–41 min)",
            description: "Tasks include multiple-choice (single/multiple answers), re-ordering paragraphs, and filling in blanks.",
            button: "Learn More ",
          },
          {
            title: "Listening (45–57 min)",
            description: "Tasks include summarizing spoken text, multiple-choice questions, filling in blanks, highlighting correct summaries, selecting missing words, highlighting incorrect words, and writing from dictation.",
            button: "Learn More ",
          },
        ].map((test, index) => (
          <div
      ...
      <div className="max-w-5xl mx-auto mt-12 sm:mt-16 px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row justify-center gap-2 text-center sm:text-left">
          ...
          <p className="leading-relaxed text-sm sm:text-base">PTE scores range from 10 to 90, with individual section scores averaged for an overall score. Both IELTS and PTE provide structured assessments to gauge English proficiency for academic, professional, and migration purposes, helping students and professionals achieve their goals abroad.</p>
        </div>
      </div>
