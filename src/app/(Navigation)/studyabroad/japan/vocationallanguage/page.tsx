    ...
    <div className="">
      ...
      <div ref={containerRef} className="container-narrow mx-auto lg:flex lg:items-start lg:gap-12 relative ">
        ...
        <div className="hidden lg:block w-64 flex-shrink-0 -mt-20  z-30 ">
          <div
            ref={sidebarRef}
            className={`w-64 rounded-sm bg-white border-2 border-[#3d1a4d] ${isSticky ? 'fixed top-28' : ''
              } ${isAtBottom ? 'absolute bottom-12 left-0' : ''
              }`}
          >
            <h6 className="text-white p-4 bg-[#3d1a4d]">VOCATIONAL SCHOOL (SENMON GAKKOU)</h6>
            <div className="">
              {menuItems.map((item) => (
                <button
                  key={item.id}
